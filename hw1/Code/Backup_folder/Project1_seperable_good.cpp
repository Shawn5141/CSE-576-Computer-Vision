...
*/
{
    ...
    for (int r = 0; r < buffer_imageHeight; r++){
        for (int c = 0; c < buffer_imageWidth; c++)
        {
            ...
            if (r< int(kernelHeight/2) || r>=imageHeight+int(kernelHeight/2) || (c<int(kernelWidth/2) || c>=imageWidth+int(kernelWidth/2))){
                ...
                //std::cout<<buffer[r*buffer_imageWidth+c][0]<<endl;
                ...
                //std::cout<<_r<<" "<<_c<<" ";
                 ...
                 //std::cout<<buffer[r*buffer_imageWidth+c][0]+buffer[r*buffer_imageWidth+c][1]+buffer[r*buffer_imageWidth+c][2]<<endl;
            }
    ...
    for (int r = 0; r < imageHeight; r++){
        for (int c = 0; c < imageWidth; c++){
            ...
            //std::cout<<Image[r*imageWidth+c][0]+Image[r*imageWidth+c][1]+Image[r*imageWidth+c][2]<<" ";
        }
        //std::cout<<"\n"<<std::endl;
    }
...
std::cout<<"Convolution fininished fuck you"<<std::endl;
...
*/
{
    ...
    for(int x=0;x<kernelHeight;x++){
        for(int y=0;y<kernelWidth;y++){
         ...
         //kernel[x*kernelWidth+y]= x*kernelWidth+y;
        std::cout<<shift_x<<"" <<shift_y<<"  ";
